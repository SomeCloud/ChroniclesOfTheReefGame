    ...
    public class AMapCellView: APrimitive, IPrimitive
    {
        ...
        public new void Draw(SpriteBatch spriteBatch)
        {
            ...
            if (Enabled)
            {
                ...
                spriteBatch.Draw(IsDarkenedTexture ? !_MapCell.IsOwned && _MapCell.Settlement is object? TexturePack.EmptyHex : TexturePack.Hex[_MapCell.OwnerId].DarkenedTexture : TexturePack.Hex[_MapCell.OwnerId].Texture, new Vector2(GlobalLocation.X + VisibleArea.Location.X, GlobalLocation.Y + VisibleArea.Location.Y), new Rectangle(VisibleArea.Location.X, VisibleArea.Location.Y, VisibleArea.Size.Width, VisibleArea.Size.Height), Color.White, 0f, Vector2.Zero, /*scaling*/1f, SpriteEffects.None, 0f);
