...
{
    public class PlayerPanelOld : APanel
    {
        ...
        public CharacterPanelOld CharacterPanel { get => _CharacterPanel; }
        ...
        public PlayerPanelOld(AGame game, ASize size) : base(size)
        {
            Game = game;
        }
        ...
        public override void Initialize()
        {
            ...
            _CharacterPanel = new CharacterPanelOld(Game, new ASize(width, Height - 80)) { Parent = this, Location = new APoint(10, 70) };
        ...
        public void Update(IPlayer player)
        {
            ...
            _SettlementsPanel.Text = "Поселения игрока: \n\n" + string.Join("\n", player.Settlements.Select(x => "[" + x.Location + "] " + x.Name + " (" + x.Income + ")"))  + "\n\nРесурсы игрока: \n\n" + string.Join("\n", player.Resources.Select(x => "" + GameLocalization.Resources[x.Key] + ": " + x.Value));
        }
