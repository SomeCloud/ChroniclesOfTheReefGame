...
{
    public class CharacterPanelOld: APanel
    {
        ...
        public CharacterPanelOld(AGame game, ASize size) : base(size)
        {
            Game = game;
        }
        
        public CharacterPanelOld(AGame game, ASize size, IPrimitiveTexture primitiveTexture) : base(size, primitiveTexture)
        {
            Game = game;
        }
