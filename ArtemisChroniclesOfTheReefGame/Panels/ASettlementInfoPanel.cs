...
{
    public class ASettlementInfoPanel: AEmptyPanel
    {

        public delegate void OnTechnologySelect();
        ...
        public ASettlementInfoPanel(ASize size) : base(size)
        {
        ...
        public override void Initialize()
        {
            ...
            InvestigatedTechnologyInfo.ExtraButtonClick += () => TechnologySelectEvent?.Invoke();
